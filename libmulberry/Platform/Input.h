...
namespace mulberry
{
    ...
    struct ControllerButtom
    {
        enum _ControllerButtom
        {
            A,
            B,
            X,
    ...
    public:
        ...
        bool GetButtonValue(ControllerButtom button) const;

        enum ButtonState GetButtonState(ControllerButtom button) const;
