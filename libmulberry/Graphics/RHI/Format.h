...
#undef ITEM
        ...
        Format(VkFormat fmt)
            : mHandle(FormatEnum(fmt))
        {
        }

        Format(FormatEnum fmt)
            : mHandle(fmt)
        {
        }
        ...
        Format &operator=(FormatEnum other)
        {
            mHandle = other;
            return *this;
        }
        FormatEnum GetHandle() const
        {
            return mHandle;
        }
        ...
        bool HasDepth()
        {
            return mHandle == Format::D32_SFLOAT_S8_UINT ||
                   mHandle == Format::D24_UNORM_S8_UINT ||
                   mHandle == Format::D16_UNORM_S8_UINT ||
                   mHandle == Format::D32_SFLOAT ||
                   mHandle == Format::D16_UNORM;
        }
    ...
    inline bool operator==(const Format &fmt1, Format::FormatEnum fmt2)
    {
        return fmt1.GetHandle() == fmt2;
    }
    inline bool operator==(Format::FormatEnum fmt1, const Format &fmt2)
    {
        return fmt2 == fmt1;
    }
    ...
    {
        return (Format::FormatEnum)fmt1 == fmt2.GetHandle();
    }
    inline bool operator==(const Format &fmt1, VkFormat fmt2)
    {
        return fmt2 == fmt1;
    }
    inline bool operator==(VkFormat fmt1, const Format::FormatEnum &fmt2)
    {
        return (Format::FormatEnum)fmt1 == fmt2;
    }
    inline bool operator==(const Format::FormatEnum &fmt1, VkFormat fmt2)
    {
        return fmt2 == fmt1;
    }
