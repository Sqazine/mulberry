...
namespace mulberry
{
	...
	void VKAdapter::EnumPhysicalDeviceSpecs()
	{
	...
	PhysicalDeviceSpec VKAdapter::EnumPhysicalDeviceSpecForHandle(VkPhysicalDevice device)
	{
	...
	void VKAdapter::PrintPhysicalDeviceSpecs()
	{
	...
	const std::vector<VkLayerProperties> &VKAdapter::GetInstanceLayerProps() const
	{
		return mInstanceLayerProps;
	}
	const std::vector<VkExtensionProperties> &VKAdapter::GetInstanceExtensionProps() const
	{
