...
namespace Pe2::VK
{
        ...
        const PipelineCache *pipelineCache)
    {
        ...
        VK_CHECK(vkCreateGraphicsPipelines(Context::GetDevice()->GetLogicalDeviceHandle(), pipelineCache == nullptr ? nullptr : pipelineCache->GetVKPipelineCacheHandle(), 1, &graphicsPipelineCreateInfo, nullptr, &m_PipelineHandle));
    }
    GraphicsPipeline::~GraphicsPipeline()
    {
        vkDestroyPipeline(Context::GetDevice()->GetLogicalDeviceHandle(), m_PipelineHandle, nullptr);
    }
